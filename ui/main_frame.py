...
class MainFrame(customtkinter.CTkFrame):
    ...
    def show_topic_editor(self, module_index, topic_index):
        ...
        types = ["text", "list", "image", "trivia", "remember", "active-recall"]
        ...
        # Centered widgets
        type_dropdown = customtkinter.CTkOptionMenu(button_row, values=types, variable=section_type)
        type_dropdown.grid(row=0, column=0, padx=8)
        add_button = customtkinter.CTkButton(button_row, text="Add Section", command=add_section)
